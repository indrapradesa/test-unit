...
<div class="col-lg-8 p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-slate-500">
    <h2 class="mb-4 text-2xl font-extrabold leading-none tracking-tight text-black md:text-2xl dark:text-white">{{ $title }}</h2>
    {{-- <section>
    <h2 class="mb-4 text-2xl font-extrabold leading-none tracking-tight text-black md:text-2xl dark:text-white">{{ $title }}</h2>
    <div class="relative grid grid-col-3 grid-flow-col gap-4">
        <div class="h-80 grid-row-3 border-2 border-dashed rounded-lg dark:border-slate-500 flex items-center justify-center">
            <img class="max-h-80 sm:w-96 rounded-lg" src="/img/logo.png" alt="image description">
        </div>
        <div class="col-span-2 p-2 px-3 py-3 border-2 border-dashed rounded-lg dark:border-slate-500">
