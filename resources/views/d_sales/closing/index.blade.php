...
<h2 class="mb-4 text-2xl font-extrabold leading-none tracking-tight text-black md:text-4xl dark:text-white">{{ $title }}</h2>
    ...
    <a href="/dashboard/closing/create" class="ml-2 focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Input Customer Closing</a>
